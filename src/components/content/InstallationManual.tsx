        ...
        <ol className="list-decimal list-inside space-y-4">
          ...
          <li>{t('installRenderV2Step2')}
            <div className="w-full h-auto relative mt-4">
              <Image src="/img/Render1.png" alt={t('installRenderV2ImgAlt1')} width={800} height={450} className="rounded-lg w-full" data-ai-hint="render dashboard" />
            </div>
          </li>
          <li>{t('installRenderV2Step3')}</li>
          <li>{t('installRenderV2Step4')}
            <div className="w-full h-auto relative mt-4">
              <Image src="/img/Render2.png" alt={t('installRenderV2ImgAlt2')} width={800} height={451} className="rounded-lg w-full" data-ai-hint="connect repository" />
            </div>
          </li>
          ...
          <li>{t('installRenderV2Step7')}
            <div className="w-full h-auto relative mt-4">
              <Image src="/img/Render3.png" alt={t('installRenderV2ImgAlt3')} width={800} height={452} className="rounded-lg w-full" data-ai-hint="deployment success" />
            </div>
          </li>
