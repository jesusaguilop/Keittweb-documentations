...
const translations: Translations = {
  ...
  welcomeCard1Desc: { es: 'Guías paso a paso para desplegar KeittWeb en un servidor y configurarlo para producción.', en: 'Step-by-step guides to deploy KeittWeb on a server and configure it for production.' },
  welcomeCard2Title: { es: 'Técnico', en: 'Technical' },
  welcomeCard2Desc: { es: 'Explicaciones detalladas sobre la arquitectura, estructura del código y procesos internos.', en: 'Detailed explanations about the architecture, code structure, and internal processes.' },
  welcomeCard3Title: { es: 'Usuario', en: 'User' },
  welcomeCard3Desc: { es: 'Instrucciones claras sobre cómo usar cada módulo y funcionalidad de la aplicación.', en: 'Clear instructions on how to use each module and feature of the application.' },
