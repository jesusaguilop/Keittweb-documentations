...
const translations: Translations = {
  ...
  folderFixturesDesc: { es: "Contiene datos iniciales para la base de datos (ej. catálogos).", en: "Contains initial data for the database (e.g., catalogs)." },
  folderMigrationsDesc: { es: "Registra los cambios en los modelos de la base de datos.", en: "Records changes to the database models." },
  folderInitDesc: { es: "Marca el directorio como un paquete de Python.", en: "Marks the directory as a Python package." },
  folderAdminDesc: { es: "Configura cómo se muestran los modelos en el admin de Django.", en: "Configures how models are displayed in the Django admin." },
  folderAppsPyDesc: { es: "Configuración específica de la aplicación.", en: "Application-specific configuration." },
  folderModelsDesc: { es: "Define la estructura de los datos (tablas, campos).", en: "Defines the data structure (tables, fields)." },
  folderSerializersDesc: { es: "Convierte los datos de modelos a formato JSON para la API.", en: "Converts model data to JSON format for the API." },
  folderAppUrlsDesc: { es: "Define las rutas (endpoints) específicas de esta aplicación.", en: "Defines the specific routes (endpoints) for this application." },
  folderViewsDesc: { es: "Contiene la lógica para manejar las peticiones y respuestas HTTP.", en: "Contains the logic for handling HTTP requests and responses." },
